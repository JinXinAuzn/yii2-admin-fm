...
namespace jx\admin_fm\components;

use jx\admin_fm\models\Logs;
...
class AdminLog extends Model
{
	...
	public static function afterInsert($event){
		if (!empty($event->changedAttributes) && $event->sender->className() != 'jx\admin_fm\models\Logs') {
	...
	public static function afterDelete($event){
		if ($event->sender->className() != 'jx\admin_fm\models\Logs') {
