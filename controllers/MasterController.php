...
use jx\admin_fm\components\AdminLog;
use Yii;
use jx\admin_fm\models\form\Login;
use jx\admin_fm\models\form\Signup;
use jx\admin_fm\models\form\ChangePassword;
use jx\admin_fm\models\Master;
use jx\admin_fm\models\searchs\Master as MasterSearch;
	...
	public function beforeAction($action)
	{
		if (parent::beforeAction($action)) {
			if (Yii::$app->has('mailer') && ($mailer = Yii::$app->getMailer()) instanceof BaseMailer) {
				...
				$mailer->setViewPath('@jx/admin_fm/mail');
			}
			return true;
		}
		return false;
